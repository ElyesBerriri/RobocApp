...
public class InputAActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_a);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(((TextView)findViewById(R.id.score)).getText().toString().equals("SCORE")){
                    Toast.makeText(InputAActivity.this, "Tu dois appuier sur le bouton 'OBTENIR LE SCORE' ", Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    {
                        Toast.makeText(InputAActivity.this, "Le score de ** "+data+" ** est bien ajouté", Toast.LENGTH_SHORT).show();
                    }).addOnFailureListener(er-> {
                        Toast.makeText(InputAActivity.this, ""+er.getMessage(), Toast.LENGTH_SHORT).show();
                    });
                    startActivity(new Intent(InputAActivity.this, NavbarHomologation.class));
                }
            }
        });
    }
    ...
    public void sum(View v) {
        ...
        int a;
        if (((EditText)findViewById(R.id.note_autre)).getText().toString().equals(""))
            a=0;
        else
            a = Integer.parseInt(((EditText)findViewById(R.id.note_autre)).getText().toString());

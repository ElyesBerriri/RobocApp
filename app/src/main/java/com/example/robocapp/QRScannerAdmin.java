...
public class QRScannerAdmin extends AppCompatActivity implements ZXingScannerView.ResultHandler {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(data).exists()) {
                    Intent intent = new Intent(QRScannerAdmin.this, EditTeam.class);
                    intent.putExtra(DATA, data);
                    startActivity(intent);
                    onBackPressed();
                }
                else{
                    Toast.makeText(QRScannerAdmin.this, "There is no registred robot who has the name : "+data+" !!!", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(QRScannerAdmin.this, AdminActivity.class);
                    startActivity(intent);
                    onBackPressed();
                }
            }
